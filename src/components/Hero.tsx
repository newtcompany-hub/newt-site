  ...
  return (
    <section id="home" className="relative min-h-screen bg-black overflow-hidden flex items-center" aria-labelledby="hero-heading">
      ...
      <div className="container mx-auto px-4 sm:px-6 md:px-6 lg:px-8 text-center relative z-10 w-full pt-20">
        <div className="max-w-4xl mx-auto space-y-4 sm:space-y-6 md:space-y-8 animate-fade-in px-2 sm:px-0" style={{ paddingTop: 'max(env(safe-area-inset-top, 0px), 1rem)' }}>
          {/* Welcome Badge */}
          ...
          {/* CTAs */}
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 pt-6 sm:pt-8 md:pt-10 animate-slide-up-delay-2 px-2 sm:px-6">
            <a
