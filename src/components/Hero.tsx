    ...
    <section id="home" className="relative min-h-screen bg-black overflow-hidden flex items-center">
      ...
      <div className="container mx-auto px-3 sm:px-4 md:px-6 lg:px-8 text-center relative z-10 w-full py-16 sm:py-20 md:py-24 lg:py-32">
        <div className="max-w-5xl mx-auto space-y-4 sm:space-y-6 md:space-y-8 animate-fade-in">
          ...
          {/* Headline */}
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-white leading-tight font-poppins animate-slide-up px-2 sm:px-4 max-w-6xl mx-auto">
            {t.hero.headline}
          </h1>

          {/* Subheadline */}
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-300 max-w-3xl lg:max-w-4xl mx-auto leading-relaxed font-inter animate-slide-up-delay px-4 sm:px-6">
            {t.hero.subheadline}
          </p>

          {/* CTAs */}
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 md:gap-8 pt-6 sm:pt-8 md:pt-10 animate-slide-up-delay-2 px-4 sm:px-6">
            <a
              href="https://wa.me/5591998382662"
              target="_blank"
              rel="noopener noreferrer"
              className="mobile-btn group bg-newt-red hover:bg-red-700 text-white px-8 sm:px-10 py-4 sm:py-5 rounded-lg font-semibold text-base sm:text-lg md:text-xl transition-colors duration-200 flex items-center space-x-3 w-full sm:w-auto justify-center focus:outline-none focus:ring-2 focus:ring-newt-red focus:ring-offset-2 focus:ring-offset-newt-black font-inter min-h-[56px]"
            >
            ...
            <button
              ...
              className="mobile-btn border-2 border-white text-white hover:bg-white hover:text-black px-8 sm:px-10 py-4 sm:py-5 rounded-lg font-semibold transition-colors duration-200 w-full sm:w-auto font-inter min-h-[56px] text-base sm:text-lg md:text-xl"
            >
              {t.hero.cta2}
            </button>
          </div>
