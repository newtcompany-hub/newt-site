    ...
    <div id="about">
      <div className="container mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
        ...
        <div className="mb-6 sm:mb-8 md:mb-12">
          <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-newt-black text-center mb-4 sm:mb-6 md:mb-8 font-poppins leading-tight" itemProp="serviceType">
            {t.about.methodology}
          </h3>
